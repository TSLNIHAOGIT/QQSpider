    ...
    def getCookie(self, account, password):
        ...
        while failure < 2:
            try:
                ...
                # browser = webdriver.PhantomJS(executable_path='/Users/ozintel/Downloads/Tsl_python_progect/znfw_project/znfw_crawer/simulation_browser_crawer/phantomjs-2.1.1-macosx/bin/phantomjs')
                wait = ui.WebDriverWait(browser, 10)
                browser.get('http://qzone.qq.com/')#'http://qzone.qq.com/?s_url=http://user.qzone.qq.com/1813710279/'
