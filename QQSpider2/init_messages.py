...
class InitMessages(object):
    ...
    def __init__(self):
        ...
        self.thread_num_QQ = 2 # 同时下载几个QQ的日志，每个QQ的抓取使用不同的cookie登录
        self.thread_num_Blog = 2  # 同时下载QQ的几篇日志
        self.thread_num_Mood = 4  # 同时下载QQ的几条说说
    ...
    def readQQForSpide(self, file_dir='QQForSpider0.txt'):
